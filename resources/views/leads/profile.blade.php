            ...
            <div class="profile-header d-flex justify-content-between justify-content-center">
                <div class="d-flex">
                    ...
                    <div class="details">
                        ...
                        <span class="text-light">{{ $lead->email }}</span>
                ...
                <div>
                    <a href="mailto:{{ $lead->email }}" class="btn btn-success btn-sm">Send mail</a>
                </div>
            </div>
        </div>                    
    </div>               
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <p class="m-b-0">{{ $lead->source }}</p>
                <hr>
                <small class="text-muted">Register date and time: </small>
                <p class="m-b-0">{{ $lead->created_at }}</p>
                <hr>
                <small class="text-muted">Contacts: </small>
                @foreach( $lead->contacts as $contact )
                    <p>{{ $contact->contactType->name }}: {{ $contact->value }}</p>
                @endforeach
